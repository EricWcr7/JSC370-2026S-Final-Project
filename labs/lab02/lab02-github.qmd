...
``` sh
https://github.com/EricWcr7/JSC370-2026-YFW.git
```
...
One of the most common tasks that people uses git for is for collaborating. While in general team members organize such that there are no overlapping editing of the files, git is smart enough to avoid clashes when multiple edits are done in the same document[^1]. To show this, we will do a collaborative edit of a file!
...
We will be working with the repository <https://github.com/JSC370/JSC370-lab2-2026-whoami>
...
Once you have the repository on your local machine, create a new branch for your changes. Use your name or a descriptive name for the branch[^2]:

[^2]: For more on branch naming conventions, see [Naming conventions for Git Branches](https://medium.com/@abhay.pixolo/naming-conventions-for-git-branches-a-cheatsheet-8549feca2534).
...
4.  Commit the changes and push the changes to your branch using `git commit` and `git push`, e.g.
...
``` sh
commit: 6913c5fe9b0033059a92db07f92fd965224ce1ff 
Author: yifanwang <yifaneric.wang@mail.utoronto.ca>
Date: Wed Jan 14 13:44:21 2026 -0500
```
